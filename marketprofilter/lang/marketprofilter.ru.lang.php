<?php
/**
 * Russian Language File for Market PRO Filter plugin for CMF Cotonti v.1+, PHP v.8.4+, MySQL v.8.0+
...
$L['marketprofilter_market_paramsItem_desc'] = 'и его характеристики, названия параметров и значения в фильтре товаров на сайте в категории';
