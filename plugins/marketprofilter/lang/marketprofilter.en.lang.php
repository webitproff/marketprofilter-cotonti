<?php
/**
 * English Language File for Market PRO Filter plugin for CMF Cotonti v.1+, PHP v.8.5+, MySQL v.8.0+
...
// English (en.lang.php)
$L['marketprofilter_param_multicats'] = 'Additional categories for the filter';
$L['marketprofilter_param_multicats_hint'] = 'Select child categories where this parameter will also be displayed. Works only with the Multicatmarket plugin enabled.';
