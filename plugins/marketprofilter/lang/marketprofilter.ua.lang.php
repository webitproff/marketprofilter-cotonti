<?php
/**
 * Ukrainian Language File for Market PRO Filter plugin for CMF Cotonti v.1+, PHP v.8.5+, MySQL v.8.0+
...
$L['marketprofilter_Hide_Filter'] = 'Приховати фільтр';
$L['marketprofilter_Show_Filter'] = 'Показати фільтр';
...
$L['marketprofilter_foldall'] = 'Згорнути список';
$L['marketprofilter_unfoldall'] = 'Розкрити список';
$L['marketprofilter_select_param_value_not_selected'] = 'обери мене!';
...
$L['marketprofilter_market_paramsItem_desc'] = 'та його характеристики, назви параметрів і значення у фільтрі товарів, для здійснення пошуку на сайті в межах своєї головної категорії.';
...
// Ukrainian (uk.lang.php)
$L['marketprofilter_param_multicats'] = 'Додаткові категорії для фільтра';
$L['marketprofilter_param_multicats_hint'] = 'Позначте дочірні категорії, в яких цей параметр також буде відображатися. Працює лише при активованому плагіні Multicatmarket.';
